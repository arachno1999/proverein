...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.mitgliedsTyp.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mitglieds-typs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jahresbeitrag') ? 'is-invalid' : '' }}" type="number" name="jahresbeitrag" id="jahresbeitrag" value="{{ old('jahresbeitrag', '') }}" step="0.01" required>

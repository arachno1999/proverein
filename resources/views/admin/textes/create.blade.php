...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.texte.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.textes.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('offiziell') ? 'is-invalid' : '' }}" name="offiziell" id="offiziell">{!! old('offiziell') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('persoenlich') ? 'is-invalid' : '' }}" name="persoenlich" id="persoenlich">{!! old('persoenlich') !!}</textarea>

...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Mitglied">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($mitglieds_typs as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-Mitglied:not(.ajaxTable)').DataTable({ buttons: dtButtons })

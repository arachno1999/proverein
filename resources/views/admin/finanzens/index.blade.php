...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Finanzen">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($finanzkategoriens as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-Finanzen:not(.ajaxTable)').DataTable({ buttons: dtButtons })
